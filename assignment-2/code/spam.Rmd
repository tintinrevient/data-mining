...
```{r mnb_top300_word_analysis, eval=FALSE, include=FALSE}
# Select top-n mutual-information terms from total vocabularies
...
```{r mnb_bigram_top300_word_analysis, eval=FALSE, include=FALSE}
# Select top-n mutual-information terms from total vocabularies
...
reviews.logreg.pred <- predict(reviews.glmnet, newx=as.matrix(train.dtm.glmet), 
                               s="lambda.1se", 
                               type="class")
...
# hyper-parameter: feature selection
# the best option: ???
train.dtm.glmet.bigram <- cbind(train.dtm.bigram.freq, train.dtm.freq)
test.dtm.glmet.bigram <- cbind(test.dtm.bigram.freq, test.dtm.freq)
...
# Tree with lowest cv error
reviews.rpart.bigram.pruned <- prune(reviews.rpart.bigram, cp=0.016)
...
```{r classifier_rf_bigram, include=FALSE}
# hyper-parameter: feature selection
# the best option: ???

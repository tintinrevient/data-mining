...
calculate.topn <- function(dtm, topn) {
  ...
  return(list(mi.order[topn], mi[mi.order[topn]]))
}
...
```{r classifier_mnb_with_bigram, include=FALSE}
# 4-fold cross validation
...
```{r classifier_rpart, include=FALSE}
# hyper-parameter: feature selection
# the best option: ???
...
```{r classifier_rpart_bigram, include=FALSE}
# hyper-parameter: feature selection
# the best option: ???

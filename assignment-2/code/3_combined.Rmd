...
test_dtm <- DocumentTermMatrix(reviews.all[-index.train], 
                               list(dictionary = dimnames(train_dtm)[[2]]))
# Test labels
...
test_dtm2 <- DocumentTermMatrix(reviews.all[-index.train], 
                                      list(dictionary = dimnames(train_dtm2)[[2]]))

```

#### Analysis of training and test bigrams

```{r train_test_split_bi_analysis}
...
test_dtm_freq <- DocumentTermMatrix(reviews.all[-index.train], 
                                    list(dictionary = dimnames(train_dtm_freq)[[2]]))
...
# Test document-term matrix for bigrams
test_dtm2_freq <- DocumentTermMatrix(reviews.all[-index.train], 
                                           list(dictionary = dimnames(train_dtm2_freq)[[2]]))
